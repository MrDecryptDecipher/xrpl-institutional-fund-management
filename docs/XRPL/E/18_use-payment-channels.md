...
URL: https://xrpl.org/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels
Section: E18
...
TipIn this example, the channel's public key is the public key from the payer's master key pair. This is perfectly safe and valid. It is also perfectly safe and valid to use a different key pair, as long as only the payer knows the public and secret keys for that key pair.
...
`https://api.altnet.rippletest.net:51234`
...
1. Payee: Check channel
1. Payer: Sign claims
1. Payer: Send claim(s) to payee
1. Payee: Verify claims
1. Payee: Provide goods or services
1. Repeat steps 3-6 as desired
1. Payee: Redeem claim
1. Payer: Request to close channel
1. Payer (or anyone else): Close expired channel
...
TipThe "settlement delay" does not delay the settlement, which can happen as fast as a ledger version closes (3-5 seconds). The "settlement delay" is a forced delay on closing the channel so that the payee has a chance to finish with settlement.
...
NoteA payment channel counts as one object toward the payer's owner reserve. The owner must keep at least enough XRP to satisfy the reserve after subtracting the XRP allocated to the payment channel.
...
| Signature | 304402204EF0AFB78AC23ED1C472E74F4299C0C21F1B21D07EFC0A3838A420F76D783A  400220154FB11B6F54320666E4C36CA7F686C16A3A0456800BBC43746F34AF50290064 (Note: this long string has been broken to fit on one line.) |
...
`304402204EF0AFB78AC23ED1C472E74F4299C0C21F1B21D07EFC0A3838A420F76D783A`

`400220154FB11B6F54320666E4C36CA7F686C16A3A0456800BBC43746F34AF50290064`
...
- The rippled server the payee queried has lost sync with the rest of the network or is experiencing an unknown bug. Use the server_info method to check the state of the server. (If you can reproduce this situation, please report an issue.)
...
- Concepts:What is XRP?Payment TypesPayment Channels
- What is XRP?
- Payment TypesPayment Channels
- Payment Channels
- Tutorials:Send XRPLook Up Transaction ResultsReliable Transaction Submission
- Send XRP
- Look Up Transaction Results
- Reliable Transaction Submission
- References:PaymentChannelClaim transactionPaymentChannelCreate transactionPaymentChannelFund transactionchannel_authorize methodchannel_verify methodPayChannel ledger object
...
![Payment Channel Flow Diagram](https://xrpl.org/assets/paychan-flow.c137f8b51599fffdc6c102e0c1a42a3d70da310fa443cb90f0cbe4904265a5a1.ac57e6ef.png)

![Image](https://t.co/i/adsct?bci=3&dv=UTC%26en-US%40posix%26Google%20Inc.%26Linux%20x86_64%26255%261280%26720%264%2624%261280%26720%260%26na&eci=2&event_id=ab897bdb-e132-4762-a437-e7e86c140cbb&events=%5B%5B%22pageview%22%2C%7B%7D%5D%5D&integration=advertiser&p_id=Twitter&p_user_id=0&pl_id=bf042d34-c4b9-452f-a4c7-a367d8294341&pt=Use%20Payment%20Channels&tw_document_href=https%3A%2F%2Fxrpl.org%2Fdocs%2Ftutorials%2Fhow-tos%2Fuse-specialized-payment-types%2Fuse-payment-channels&tw_iframe_status=0&tw_order_quantity=0&tw_sale_amount=0&txn_id=o309v&type=javascript&version=2.3.34)

![Image](https://analytics.twitter.com/i/adsct?bci=3&dv=UTC%26en-US%40posix%26Google%20Inc.%26Linux%20x86_64%26255%261280%26720%264%2624%261280%26720%260%26na&eci=2&event_id=ab897bdb-e132-4762-a437-e7e86c140cbb&events=%5B%5B%22pageview%22%2C%7B%7D%5D%5D&integration=advertiser&p_id=Twitter&p_user_id=0&pl_id
integration=advertiser&p_id=Twitter&p_user_id=0&pl_id=bf042d34-c4b9-452f-a4c7-a367d8294341&pt=Use%20Payment%20Channels&tw_document_href=https%3A%2F%2Fxrpl.org%2Fdocs%2Ftutorials%2Fhow-tos%2Fuse-specialized-payment-types%2Fuse-payment-channels&tw_iframe_status=0&tw_order_quantity=0&tw_sale_amount=0&txn_id=o309v&type=javascript&version=2.3.34)

![Image](https://analytics.twitter.com/i/adsct?bci=3&dv=UTC%26en-US%40posix%26Google%20Inc.%26Linux%20x86_64%26255%261280%26720%264%2624%261280%26720%260%26na&eci=2&event_id=fd23168d-0902-428c-9866-f521c2dc6c67&events=%5B%5B%22pageview%22%2C%7B%7D%5D%5D&integration=advertiser&p_id=Twitter&p_user_id=0&pl_id=bf042d34-c4b9-452f-a4c7-a367d8294341&pt=Use%20Payment%20Channels&tw_document_href=https%3A%2F%2Fxrpl.org%2Fdocs%2Ftutorials%2Fhow-tos%2Fuse-specialized-payment-types%2Fuse-payment-channels&tw_iframe_status=0&tw_order_quantity=0&tw_sale_amount=0&txn_id=o309v&type=javascript&version=2.3.34)

![Image](https://t.co/i/adsct?bci=3&dv=UTC%26en-US%40posix%26Google%20Inc.%26Linux%20x86_64%26255%261280%26720%264%2624%261280%26720%260%26na&eci=2&event_id=9678273a-df58-4054-ae78-165d551ddb38&events=%5B%5B%22pageview%22%2C%7B%7D%5D%5D&integration=advertiser&p_id=Twitter&p_user_id=0&pl_id=bf042d34-c4b9-452f-a4c7-a367d8294341&pt=Use%20Payment%20Channels&tw_document_href=https%3A%2F%2Fxrpl.org%2Fdocs%2Ftutorials%2Fhow-tos%2Fuse-specialized-payment-types%2Fuse-payment-channels&tw_iframe_status=0&tw_order_quantity=0&tw_sale_amount=0&txn_id=o61w3&type=javascript&version=2.3.34)

![Image](https://analytics.twitter.com/i/adsct?bci=3&dv=UTC%26en-US%40posix%26Google%20Inc.%26Linux%20x86_64%26255%261280%26720%264%2624%261280%26720%260%26na&eci=2&event_id=9678273a-df58-4054-ae78-165d551ddb38&events=%5B%5B%22pageview%22%2C%7B%7D%5D%5D&integration=advertiser&p_id=Twitter&p_user_id=0&pl_id=bf042d34-c4b9-452f-a4c7-a367d8294341&pt=Use%20Payment%20Channels&tw_document_href=https%3A%2F%2Fxrpl.org%2Fdocs%2Ftutorials%2Fhow-tos%2Fuse-specialized-payment-types%2Fuse-payment-channels&tw_iframe_status=0&tw_order_quantity=0&tw_sale_amount=0&txn_id=o61w3&type=javascript&version=2.3.34)
...
- [About](https://xrpl.org/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels#)
...
- [Docs](https://xrpl.org/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels#)
...
- [Resources](https://xrpl.org/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels#)
...
- [Community](https://xrpl.org/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels#)
...
- [Edit](https://github.com/XRPLF/xrpl-dev-portal/tree/master/docs/tutorials/how-tos/use-specialized-payment-types/use-payment-channels/index.md)
...
---
Crawled on: 2025-09-30T01:40:03.223Z
