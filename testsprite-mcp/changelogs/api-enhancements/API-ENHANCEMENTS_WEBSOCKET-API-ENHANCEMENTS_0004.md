# Changelog - API-ENHANCEMENTS_WEBSOCKET-API-ENHANCEMENTS_0004

## Changelog Metadata
- **Changelog ID:** API-ENHANCEMENTS_WEBSOCKET-API-ENHANCEMENTS_0004
...
- **Throughput:** 64% increase in requests per second
