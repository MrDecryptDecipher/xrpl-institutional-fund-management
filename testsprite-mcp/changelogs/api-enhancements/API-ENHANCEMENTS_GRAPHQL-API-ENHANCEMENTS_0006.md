# Changelog - API-ENHANCEMENTS_GRAPHQL-API-ENHANCEMENTS_0006

## Changelog Metadata
- **Changelog ID:** API-ENHANCEMENTS_GRAPHQL-API-ENHANCEMENTS_0006
...
- **Throughput:** 104% increase in requests per second
