# Changelog - API-ENHANCEMENTS_WEBSOCKET-API-ENHANCEMENTS_0008

## Changelog Metadata
- **Changelog ID:** API-ENHANCEMENTS_WEBSOCKET-API-ENHANCEMENTS_0008
...
- **Throughput:** 58% increase in transaction processing capacity
