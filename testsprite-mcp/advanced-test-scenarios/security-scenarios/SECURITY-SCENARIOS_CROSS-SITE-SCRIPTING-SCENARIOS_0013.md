# Advanced Test Scenario - SECURITY-SCENARIOS_CROSS-SITE-SCRIPTING-SCENARIOS_0013

## Scenario Metadata
- **Scenario ID:** SECURITY-SCENARIOS_CROSS-SITE-SCRIPTING-SCENARIOS_0013
- **Category:** security-scenarios
- **Subcategory:** cross-site-scripting-scenarios
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.563Z
  ...
  "transactions": [
    {
      ...
      "amount": 3639,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.563Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 718 operations per second
...
- **Resource Usage:** < 89% CPU, < 85% memory
