# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0006

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0006
...
### Performance Results
- **Throughput:** 374 operations per second
...
- **Concurrent Users:** Support for 1963 concurrent users
- **Resource Usage:** < 73% CPU, < 79% memory
...
- 95th Percentile: 572ms
- 99th Percentile: 669ms
- Throughput: 933 RPS
- Concurrent Users: 1974
```
...
- **MTBF (Mean Time Between Failures):** 872 hours
