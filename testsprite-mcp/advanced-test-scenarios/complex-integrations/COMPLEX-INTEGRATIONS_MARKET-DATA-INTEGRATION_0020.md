# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0020

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0020
...
### Performance Results
- **Throughput:** 550 operations per second
...
### Performance Targets
- **Response Time:** < 275ms for 95th percentile
- **Throughput:** > 516 requests per second
- **Concurrent Users:** Support for 1391 concurrent users
- **Resource Usage:** < 73% CPU, < 88% memory
...
- 95th Percentile: 344ms
- 99th Percentile: 663ms
- Throughput: 609 RPS
- Concurrent Users: 1772
```
...
- **MTBF (Mean Time Between Failures):** 486 hours
