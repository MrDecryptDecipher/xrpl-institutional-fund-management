# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0018

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0018
...
- **Throughput:** > 566 requests per second
- **Concurrent Users:** Support for 1650 concurrent users
- **Resource Usage:** < 83% CPU, < 71% memory
...
- 95th Percentile: 244ms
- 99th Percentile: 549ms
- Throughput: 712 RPS
- Concurrent Users: 1882
```
...
- **MTBF (Mean Time Between Failures):** 353 hours
