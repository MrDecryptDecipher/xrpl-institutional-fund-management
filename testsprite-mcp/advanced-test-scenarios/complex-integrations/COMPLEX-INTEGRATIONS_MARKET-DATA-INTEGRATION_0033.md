# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0033

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0033
...
### Performance Results
- **Throughput:** 132 operations per second
- **Latency:** 317ms average response time
...
- **Throughput:** > 971 requests per second
- **Concurrent Users:** Support for 1514 concurrent users
- **Resource Usage:** < 89% CPU, < 72% memory
...
- **MTBF (Mean Time Between Failures):** 174 hours
