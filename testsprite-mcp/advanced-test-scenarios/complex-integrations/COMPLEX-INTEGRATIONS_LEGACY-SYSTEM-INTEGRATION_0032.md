# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0032

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0032
- **Category:** complex-integrations
- **Subcategory:** legacy-system-integration
- **Scenario Number:** 32
- **Created:** 2025-10-11T21:28:31.229Z
- **Complexity:** COMPLEX
- **Risk Level:** LOW
  ...
  "transactions": [
    {
      ...
      "amount": 12050,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.229Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 1058 operations per second
- **Latency:** 158ms average response time
...
### Performance Targets
- **Response Time:** < 290ms for 95th percentile
- **Throughput:** > 807 requests per second
- **Concurrent Users:** Support for 1043 concurrent users
- **Resource Usage:** < 74% CPU, < 70% memory
...
- 95th Percentile: 334ms
- 99th Percentile: 834ms
- Throughput: 552 RPS
- Concurrent Users: 1298
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 72 minutes
- **RPO (Recovery Point Objective):** 26 minutes
- **MTTR (Mean Time To Recovery):** 78 minutes
- **MTBF (Mean Time Between Failures):** 173 hours
