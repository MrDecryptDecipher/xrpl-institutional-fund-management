# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0001

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0001
...
### Performance Results
- **Throughput:** 871 operations per second
- **Latency:** 285ms average response time
...
### Performance Targets
- **Response Time:** < 220ms for 95th percentile
- **Throughput:** > 721 requests per second
- **Concurrent Users:** Support for 1726 concurrent users
- **Resource Usage:** < 89% CPU, < 80% memory
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 74 minutes
- **RPO (Recovery Point Objective):** 5 minutes
- **MTTR (Mean Time To Recovery):** 36 minutes
