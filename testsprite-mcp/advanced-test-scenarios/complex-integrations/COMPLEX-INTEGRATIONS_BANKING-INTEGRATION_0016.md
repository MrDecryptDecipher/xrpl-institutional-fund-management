# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0016

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0016
- **Category:** complex-integrations
- **Subcategory:** banking-integration
- **Scenario Number:** 16
- **Created:** 2025-10-11T21:28:31.247Z
- **Complexity:** MODERATE
- **Risk Level:** LOW
  ...
  "transactions": [
    {
      ...
      "amount": 10642,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.247Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 485 operations per second
- **Latency:** 72ms average response time
...
- **Throughput:** > 597 requests per second
- **Concurrent Users:** Support for 1580 concurrent users
- **Resource Usage:** < 84% CPU, < 74% memory
...
- 99th Percentile: 606ms
- Throughput: 790 RPS
- Concurrent Users: 1046
```
...
- **MTTR (Mean Time To Recovery):** 66 minutes
- **MTBF (Mean Time Between Failures):** 529 hours
