# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0040

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0040
...
### Performance Results
- **Throughput:** 255 operations per second
...
- **Throughput:** > 916 requests per second
- **Concurrent Users:** Support for 1115 concurrent users
- **Resource Usage:** < 74% CPU, < 73% memory
...
- 99th Percentile: 576ms
- Throughput: 535 RPS
- Concurrent Users: 1014
```
...
- **MTTR (Mean Time To Recovery):** 148 minutes
- **MTBF (Mean Time Between Failures):** 691 hours
