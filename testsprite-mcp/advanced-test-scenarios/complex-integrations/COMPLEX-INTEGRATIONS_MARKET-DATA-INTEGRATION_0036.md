# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0036

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0036
...
### Performance Results
- **Throughput:** 334 operations per second
...
### Performance Targets
- **Response Time:** < 134ms for 95th percentile
- **Throughput:** > 551 requests per second
- **Concurrent Users:** Support for 1032 concurrent users
- **Resource Usage:** < 89% CPU, < 84% memory
...
- 99th Percentile: 657ms
- Throughput: 743 RPS
- Concurrent Users: 1408
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 52 minutes
- **RPO (Recovery Point Objective):** 26 minutes
- **MTTR (Mean Time To Recovery):** 83 minutes
- **MTBF (Mean Time Between Failures):** 603 hours
