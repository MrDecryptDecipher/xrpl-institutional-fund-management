# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MULTI-CHAIN-INTEGRATION_0002

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MULTI-CHAIN-INTEGRATION_0002
  ...
  "transactions": [
    {
      ...
      "amount": 48682,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.191Z"
    }
  ]
}
```
...
- **Throughput:** > 616 requests per second
- **Concurrent Users:** Support for 1194 concurrent users
...
- **MTBF (Mean Time Between Failures):** 806 hours
