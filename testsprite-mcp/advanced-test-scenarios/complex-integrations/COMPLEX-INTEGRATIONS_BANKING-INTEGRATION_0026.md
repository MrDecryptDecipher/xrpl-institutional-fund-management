# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0026

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0026
...
### Performance Results
- **Throughput:** 328 operations per second
...
### Performance Targets
- **Response Time:** < 286ms for 95th percentile
- **Throughput:** > 706 requests per second
- **Concurrent Users:** Support for 1489 concurrent users
- **Resource Usage:** < 84% CPU, < 77% memory
...
- 99th Percentile: 393ms
- Throughput: 653 RPS
- Concurrent Users: 1904
```
...
- **MTBF (Mean Time Between Failures):** 333 hours
