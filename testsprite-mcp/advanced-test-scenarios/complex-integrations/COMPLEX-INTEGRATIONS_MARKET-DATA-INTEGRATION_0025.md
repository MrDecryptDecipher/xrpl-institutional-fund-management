# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0025

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0025
...
### Performance Results
- **Throughput:** 721 operations per second
- **Latency:** 66ms average response time
...
- **Throughput:** > 713 requests per second
- **Concurrent Users:** Support for 1219 concurrent users
- **Resource Usage:** < 70% CPU, < 75% memory
...
- 99th Percentile: 417ms
- Throughput: 814 RPS
- Concurrent Users: 1951
```
...
- **MTBF (Mean Time Between Failures):** 334 hours
