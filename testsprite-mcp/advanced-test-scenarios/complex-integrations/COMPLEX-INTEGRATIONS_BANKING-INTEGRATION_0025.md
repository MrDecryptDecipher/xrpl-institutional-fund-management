# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0025

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0025
...
### Performance Results
- **Throughput:** 877 operations per second
...
- **Concurrent Users:** Support for 1326 concurrent users
- **Resource Usage:** < 70% CPU, < 84% memory
...
- **MTBF (Mean Time Between Failures):** 801 hours
