# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0008

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0008
...
### Performance Results
- **Throughput:** 436 operations per second
- **Latency:** 194ms average response time
...
### Performance Targets
- **Response Time:** < 163ms for 95th percentile
- **Throughput:** > 699 requests per second
- **Concurrent Users:** Support for 1595 concurrent users
- **Resource Usage:** < 79% CPU, < 75% memory
...
- 95th Percentile: 268ms
- 99th Percentile: 717ms
- Throughput: 892 RPS
...
- **MTBF (Mean Time Between Failures):** 712 hours
