# Advanced Test Scenario - COMPLEX-INTEGRATIONS_ANALYTICS-INTEGRATION_0013

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_ANALYTICS-INTEGRATION_0013
- **Category:** complex-integrations
- **Subcategory:** analytics-integration
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.266Z
...
### Performance Results
- **Throughput:** 569 operations per second
- **Latency:** 293ms average response time
...
### Performance Targets
- **Response Time:** < 179ms for 95th percentile
- **Throughput:** > 541 requests per second
- **Concurrent Users:** Support for 1358 concurrent users
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 17 minutes
- **RPO (Recovery Point Objective):** 25 minutes
- **MTTR (Mean Time To Recovery):** 120 minutes
- **MTBF (Mean Time Between Failures):** 862 hours
