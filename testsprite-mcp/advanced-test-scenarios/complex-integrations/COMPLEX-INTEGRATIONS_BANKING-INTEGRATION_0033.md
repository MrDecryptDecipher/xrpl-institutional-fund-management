# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0033

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0033
...
### Performance Results
- **Throughput:** 115 operations per second
...
- **Throughput:** > 786 requests per second
- **Concurrent Users:** Support for 1854 concurrent users
- **Resource Usage:** < 70% CPU, < 74% memory
...
- **MTBF (Mean Time Between Failures):** 553 hours
