# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0022

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0022
- **Category:** complex-integrations
- **Subcategory:** legacy-system-integration
- **Scenario Number:** 22
- **Created:** 2025-10-11T21:28:31.228Z
- **Complexity:** COMPLEX
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 60459,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.228Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 962 operations per second
- **Latency:** 318ms average response time
...
- **Throughput:** > 783 requests per second
- **Concurrent Users:** Support for 1939 concurrent users
- **Resource Usage:** < 76% CPU, < 71% memory
...
- 99th Percentile: 366ms
- Throughput: 843 RPS
- Concurrent Users: 1174
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 48 minutes
- **RPO (Recovery Point Objective):** 27 minutes
- **MTTR (Mean Time To Recovery):** 46 minutes
- **MTBF (Mean Time Between Failures):** 318 hours
