# Advanced Test Scenario - COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0022

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0022
- **Category:** complex-integrations
- **Subcategory:** compliance-integration
- **Scenario Number:** 22
- **Created:** 2025-10-11T21:28:31.253Z
- **Complexity:** COMPLEX
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 39949,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.253Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 869 operations per second
- **Latency:** 415ms average response time
...
### Performance Targets
- **Response Time:** < 251ms for 95th percentile
- **Throughput:** > 977 requests per second
- **Concurrent Users:** Support for 1621 concurrent users
- **Resource Usage:** < 83% CPU, < 75% memory
...
- 99th Percentile: 594ms
- Throughput: 542 RPS
- Concurrent Users: 1739
```
...
- **MTTR (Mean Time To Recovery):** 120 minutes
- **MTBF (Mean Time Between Failures):** 676 hours
