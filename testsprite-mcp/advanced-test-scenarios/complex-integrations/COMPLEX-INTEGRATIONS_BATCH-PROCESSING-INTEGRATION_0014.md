# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BATCH-PROCESSING-INTEGRATION_0014

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BATCH-PROCESSING-INTEGRATION_0014
...
### Performance Results
- **Throughput:** 782 operations per second
- **Latency:** 173ms average response time
...
- **Throughput:** > 884 requests per second
- **Concurrent Users:** Support for 1579 concurrent users
- **Resource Usage:** < 85% CPU, < 84% memory
...
- 95th Percentile: 376ms
- 99th Percentile: 528ms
- Throughput: 675 RPS
- Concurrent Users: 1609
```
...
- **MTTR (Mean Time To Recovery):** 54 minutes
- **MTBF (Mean Time Between Failures):** 462 hours
