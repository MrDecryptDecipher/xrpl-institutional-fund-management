# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0005

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0005
...
### Performance Results
- **Throughput:** 527 operations per second
...
- **Throughput:** > 613 requests per second
- **Concurrent Users:** Support for 1133 concurrent users
- **Resource Usage:** < 89% CPU, < 75% memory
...
- **MTBF (Mean Time Between Failures):** 243 hours
