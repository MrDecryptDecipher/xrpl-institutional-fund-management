# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0034

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0034
...
### Performance Results
- **Throughput:** 1078 operations per second
...
### Performance Targets
- **Response Time:** < 276ms for 95th percentile
- **Throughput:** > 775 requests per second
- **Concurrent Users:** Support for 1204 concurrent users
- **Resource Usage:** < 74% CPU, < 87% memory
...
- 95th Percentile: 564ms
- 99th Percentile: 339ms
- Throughput: 826 RPS
- Concurrent Users: 1967
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 43 minutes
- **RPO (Recovery Point Objective):** 21 minutes
- **MTTR (Mean Time To Recovery):** 90 minutes
- **MTBF (Mean Time Between Failures):** 515 hours
