# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0021

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0021
...
### Performance Results
- **Throughput:** 610 operations per second
- **Latency:** 313ms average response time
...
### Performance Targets
- **Response Time:** < 208ms for 95th percentile
- **Throughput:** > 745 requests per second
- **Concurrent Users:** Support for 1124 concurrent users
...
- 95th Percentile: 430ms
- 99th Percentile: 771ms
- Throughput: 885 RPS
- Concurrent Users: 1623
```
...
- **MTTR (Mean Time To Recovery):** 69 minutes
