# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0004

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0004
- **Category:** complex-integrations
- **Subcategory:** legacy-system-integration
- **Scenario Number:** 4
- **Created:** 2025-10-11T21:28:31.226Z
  ...
  "transactions": [
    {
      ...
      "amount": 46341,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.226Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 902 operations per second
...
### Performance Targets
- **Response Time:** < 291ms for 95th percentile
- **Throughput:** > 624 requests per second
- **Concurrent Users:** Support for 1347 concurrent users
...
- 95th Percentile: 368ms
- 99th Percentile: 771ms
- Throughput: 696 RPS
- Concurrent Users: 1672
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 59 minutes
- **RPO (Recovery Point Objective):** 13 minutes
- **MTTR (Mean Time To Recovery):** 113 minutes
- **MTBF (Mean Time Between Failures):** 484 hours
