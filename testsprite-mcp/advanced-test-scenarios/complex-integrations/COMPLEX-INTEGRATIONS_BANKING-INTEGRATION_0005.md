# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0005

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0005
- **Category:** complex-integrations
- **Subcategory:** banking-integration
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.245Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 46343,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.245Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 464 operations per second
- **Latency:** 405ms average response time
...
- **Throughput:** > 855 requests per second
- **Concurrent Users:** Support for 1874 concurrent users
- **Resource Usage:** < 83% CPU, < 89% memory
...
- **MTTR (Mean Time To Recovery):** 145 minutes
- **MTBF (Mean Time Between Failures):** 303 hours
