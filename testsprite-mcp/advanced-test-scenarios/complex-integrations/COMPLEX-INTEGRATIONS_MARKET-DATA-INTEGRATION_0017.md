# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0017

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0017
- **Category:** complex-integrations
- **Subcategory:** market-data-integration
- **Scenario Number:** 17
- **Created:** 2025-10-11T21:28:31.258Z
- **Complexity:** COMPLEX
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 70666,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.258Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 694 operations per second
- **Latency:** 396ms average response time
...
### Performance Targets
- **Response Time:** < 123ms for 95th percentile
- **Throughput:** > 657 requests per second
- **Concurrent Users:** Support for 1711 concurrent users
- **Resource Usage:** < 72% CPU, < 79% memory
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 61 minutes
- **RPO (Recovery Point Objective):** 22 minutes
- **MTTR (Mean Time To Recovery):** 139 minutes
- **MTBF (Mean Time Between Failures):** 787 hours
