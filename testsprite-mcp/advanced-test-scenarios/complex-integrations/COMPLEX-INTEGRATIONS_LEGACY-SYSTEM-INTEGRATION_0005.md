# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0005

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0005
...
- **Latency:** 334ms average response time
...
- **Throughput:** > 808 requests per second
- **Concurrent Users:** Support for 1506 concurrent users
- **Resource Usage:** < 72% CPU, < 72% memory
...
- 95th Percentile: 354ms
- 99th Percentile: 786ms
- Throughput: 562 RPS
- Concurrent Users: 1985
```
...
- **MTBF (Mean Time Between Failures):** 733 hours
