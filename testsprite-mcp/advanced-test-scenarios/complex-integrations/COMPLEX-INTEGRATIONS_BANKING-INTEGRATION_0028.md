# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0028

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0028
...
### Performance Results
- **Throughput:** 370 operations per second
- **Latency:** 131ms average response time
...
- **Throughput:** > 788 requests per second
- **Concurrent Users:** Support for 1037 concurrent users
- **Resource Usage:** < 82% CPU, < 80% memory
...
- 99th Percentile: 381ms
- Throughput: 531 RPS
- Concurrent Users: 1690
```
...
- **MTBF (Mean Time Between Failures):** 831 hours
