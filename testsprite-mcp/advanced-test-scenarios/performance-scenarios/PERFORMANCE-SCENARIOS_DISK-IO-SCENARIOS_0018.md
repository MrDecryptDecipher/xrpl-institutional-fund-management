# Advanced Test Scenario - PERFORMANCE-SCENARIOS_DISK-IO-SCENARIOS_0018

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_DISK-IO-SCENARIOS_0018
- **Category:** performance-scenarios
- **Subcategory:** disk-io-scenarios
- **Scenario Number:** 18
- **Created:** 2025-10-11T21:28:31.531Z
  ...
  "transactions": [
    {
      ...
      "amount": 58352,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.531Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 408 operations per second
