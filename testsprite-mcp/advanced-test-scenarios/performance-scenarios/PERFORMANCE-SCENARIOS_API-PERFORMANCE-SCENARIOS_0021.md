# Advanced Test Scenario - PERFORMANCE-SCENARIOS_API-PERFORMANCE-SCENARIOS_0021

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_API-PERFORMANCE-SCENARIOS_0021
- **Category:** performance-scenarios
- **Subcategory:** api-performance-scenarios
- **Scenario Number:** 21
- **Created:** 2025-10-11T21:28:31.538Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 21856,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.538Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1072 concurrent users
