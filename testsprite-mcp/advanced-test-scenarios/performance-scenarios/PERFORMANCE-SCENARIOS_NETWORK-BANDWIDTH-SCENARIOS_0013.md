# Advanced Test Scenario - PERFORMANCE-SCENARIOS_NETWORK-BANDWIDTH-SCENARIOS_0013

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_NETWORK-BANDWIDTH-SCENARIOS_0013
- **Category:** performance-scenarios
- **Subcategory:** network-bandwidth-scenarios
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.533Z
  ...
  "transactions": [
    {
      ...
      "amount": 41075,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.533Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 930 operations per second
...
- **Throughput:** > 700 requests per second
- **Concurrent Users:** Support for 1171 concurrent users
