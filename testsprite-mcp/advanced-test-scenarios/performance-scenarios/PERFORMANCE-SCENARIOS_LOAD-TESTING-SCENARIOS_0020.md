# Advanced Test Scenario - PERFORMANCE-SCENARIOS_LOAD-TESTING-SCENARIOS_0020

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_LOAD-TESTING-SCENARIOS_0020
- **Category:** performance-scenarios
- **Subcategory:** load-testing-scenarios
- **Scenario Number:** 20
- **Created:** 2025-10-11T21:28:31.507Z
- **Complexity:** SIMPLE
- **Risk Level:** LOW
  ...
  "transactions": [
    {
      ...
      "amount": 30497,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.507Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 799 operations per second
...
- **Concurrent Users:** Support for 1087 concurrent users
