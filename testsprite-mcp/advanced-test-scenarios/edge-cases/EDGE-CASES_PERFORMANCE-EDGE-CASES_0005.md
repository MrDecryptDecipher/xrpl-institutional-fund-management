# Advanced Test Scenario - EDGE-CASES_PERFORMANCE-EDGE-CASES_0005

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_PERFORMANCE-EDGE-CASES_0005
- **Category:** edge-cases
- **Subcategory:** performance-edge-cases
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.304Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 89775,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.304Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 927 operations per second
...
- **Concurrent Users:** Support for 1966 concurrent users
- **Resource Usage:** < 84% CPU, < 83% memory
...
Target Performance:
- Average Response Time: 150ms
- 95th Percentile: 254ms
- 99th Percentile: 534ms
- Throughput: 923 RPS
- Concurrent Users: 1287
```
...
- **MTTR (Mean Time To Recovery):** 50 minutes
- **MTBF (Mean Time Between Failures):** 395 hours
