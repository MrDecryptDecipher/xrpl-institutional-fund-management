# Advanced Test Scenario - EDGE-CASES_AUTHORIZATION-EDGE-CASES_0022

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_AUTHORIZATION-EDGE-CASES_0022
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 912 operations per second
...
### Performance Targets
- **Response Time:** < 108ms for 95th percentile
- **Throughput:** > 769 requests per second
- **Concurrent Users:** Support for 1893 concurrent users
...
- 95th Percentile: 524ms
- 99th Percentile: 477ms
- Throughput: 534 RPS
...
- **MTBF (Mean Time Between Failures):** 546 hours
