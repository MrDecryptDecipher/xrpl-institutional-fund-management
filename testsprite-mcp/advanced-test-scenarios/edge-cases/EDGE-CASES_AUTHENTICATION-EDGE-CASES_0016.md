# Advanced Test Scenario - EDGE-CASES_AUTHENTICATION-EDGE-CASES_0016

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_AUTHENTICATION-EDGE-CASES_0016
- **Category:** edge-cases
...
- **Throughput:** > 622 requests per second
- **Concurrent Users:** Support for 1601 concurrent users
- **Resource Usage:** < 88% CPU, < 82% memory
