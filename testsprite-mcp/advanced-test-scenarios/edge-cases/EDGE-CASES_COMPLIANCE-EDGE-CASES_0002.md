# Advanced Test Scenario - EDGE-CASES_COMPLIANCE-EDGE-CASES_0002

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_COMPLIANCE-EDGE-CASES_0002
- **Category:** edge-cases
  ...
  "transactions": [
    {
      ...
      "amount": 78091,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.316Z"
    }
  ]
}
```
...
### Performance Targets
- **Response Time:** < 234ms for 95th percentile
- **Throughput:** > 650 requests per second
- **Concurrent Users:** Support for 1123 concurrent users
...
- **MTBF (Mean Time Between Failures):** 239 hours
