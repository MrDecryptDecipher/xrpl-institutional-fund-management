# Advanced Test Scenario - EDGE-CASES_TIME-ZONE-EDGE-CASES_0009

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TIME-ZONE-EDGE-CASES_0009
- **Category:** edge-cases
- **Subcategory:** time-zone-edge-cases
- **Scenario Number:** 9
- **Created:** 2025-10-11T21:28:31.355Z
  ...
  "transactions": [
    {
      ...
      "amount": 99449,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.355Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 1052 operations per second
- **Latency:** 205ms average response time
...
### Performance Targets
- **Response Time:** < 279ms for 95th percentile
- **Throughput:** > 892 requests per second
- **Concurrent Users:** Support for 1235 concurrent users
- **Resource Usage:** < 75% CPU, < 70% memory
...
- **MTBF (Mean Time Between Failures):** 565 hours
