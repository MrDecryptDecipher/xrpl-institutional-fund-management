# Advanced Test Scenario - EDGE-CASES_TIME-ZONE-EDGE-CASES_0029

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TIME-ZONE-EDGE-CASES_0029
- **Category:** edge-cases
- **Subcategory:** time-zone-edge-cases
- **Scenario Number:** 29
- **Created:** 2025-10-11T21:28:31.358Z
  ...
  "transactions": [
    {
      ...
      "amount": 86368,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.358Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 870 operations per second
...
- **Concurrent Users:** Support for 1561 concurrent users
- **Resource Usage:** < 78% CPU, < 82% memory
...
- **MTBF (Mean Time Between Failures):** 574 hours
