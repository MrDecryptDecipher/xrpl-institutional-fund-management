# Advanced Test Scenario - EDGE-CASES_VALIDATION-EDGE-CASES_0018

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_VALIDATION-EDGE-CASES_0018
- **Category:** edge-cases
- **Subcategory:** validation-edge-cases
- **Scenario Number:** 18
- **Created:** 2025-10-11T21:28:31.390Z
  ...
  "transactions": [
    {
      ...
      "amount": 95360,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.390Z"
    }
  ]
}
```
...
- **Throughput:** > 776 requests per second
- **Concurrent Users:** Support for 1606 concurrent users
- **Resource Usage:** < 73% CPU, < 75% memory
...
- 95th Percentile: 394ms
- 99th Percentile: 774ms
- Throughput: 590 RPS
- Concurrent Users: 1442
```
