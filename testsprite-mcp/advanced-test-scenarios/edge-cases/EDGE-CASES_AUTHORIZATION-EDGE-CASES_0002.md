# Advanced Test Scenario - EDGE-CASES_AUTHORIZATION-EDGE-CASES_0002

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_AUTHORIZATION-EDGE-CASES_0002
- **Category:** edge-cases
- **Subcategory:** authorization-edge-cases
- **Scenario Number:** 2
- **Created:** 2025-10-11T21:28:31.398Z
- **Complexity:** COMPLEX
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 41774,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.398Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 386 operations per second
- **Latency:** 435ms average response time
...
- **Throughput:** > 579 requests per second
...
- 99th Percentile: 336ms
- Throughput: 835 RPS
- Concurrent Users: 1103
```
...
- **MTBF (Mean Time Between Failures):** 169 hours
