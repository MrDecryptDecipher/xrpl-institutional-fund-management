# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0008

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0008
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 228 operations per second
- **Latency:** 472ms average response time
...
- **MTBF (Mean Time Between Failures):** 780 hours
