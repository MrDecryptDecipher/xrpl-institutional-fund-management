# Advanced Test Scenario - EDGE-CASES_SYSTEM-RESOURCE-EDGE-CASES_0004

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_SYSTEM-RESOURCE-EDGE-CASES_0004
- **Category:** edge-cases
...
- **Throughput:** > 530 requests per second
- **Concurrent Users:** Support for 1709 concurrent users
- **Resource Usage:** < 72% CPU, < 78% memory
