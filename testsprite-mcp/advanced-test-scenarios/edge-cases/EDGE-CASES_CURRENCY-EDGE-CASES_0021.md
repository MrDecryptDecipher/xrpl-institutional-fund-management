# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0021

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0021
- **Category:** edge-cases
- **Subcategory:** currency-edge-cases
- **Scenario Number:** 21
- **Created:** 2025-10-11T21:28:31.373Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 10380,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.373Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 347 operations per second
...
- **Resource Usage:** < 82% CPU, < 88% memory
