# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0009

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0009
- **Category:** edge-cases
  ...
  "transactions": [
    {
      ...
      "amount": 45832,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.364Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 404 operations per second
- **Latency:** 384ms average response time
...
- **Throughput:** > 605 requests per second
- **Concurrent Users:** Support for 1669 concurrent users
