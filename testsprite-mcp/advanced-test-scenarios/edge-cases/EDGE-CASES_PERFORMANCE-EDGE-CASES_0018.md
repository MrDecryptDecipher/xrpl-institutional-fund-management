# Advanced Test Scenario - EDGE-CASES_PERFORMANCE-EDGE-CASES_0018

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_PERFORMANCE-EDGE-CASES_0018
- **Category:** edge-cases
- **Subcategory:** performance-edge-cases
- **Scenario Number:** 18
- **Created:** 2025-10-11T21:28:31.311Z
  ...
  "transactions": [
    {
      ...
      "amount": 39587,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.311Z"
    }
  ]
}
```
...
- **Throughput:** > 694 requests per second
- **Concurrent Users:** Support for 1047 concurrent users
- **Resource Usage:** < 80% CPU, < 72% memory
