# Advanced Test Scenario - EDGE-CASES_TRANSACTION-EDGE-CASES_0017

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TRANSACTION-EDGE-CASES_0017
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 475 operations per second
...
- **Throughput:** > 953 requests per second
- **Concurrent Users:** Support for 1831 concurrent users
- **Resource Usage:** < 83% CPU, < 88% memory
