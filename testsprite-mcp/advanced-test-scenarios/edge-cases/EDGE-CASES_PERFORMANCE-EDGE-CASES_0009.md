# Advanced Test Scenario - EDGE-CASES_PERFORMANCE-EDGE-CASES_0009

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_PERFORMANCE-EDGE-CASES_0009
- **Category:** edge-cases
- **Subcategory:** performance-edge-cases
- **Scenario Number:** 9
- **Created:** 2025-10-11T21:28:31.309Z
  ...
  "transactions": [
    {
      ...
      "amount": 44494,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.309Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 728 operations per second
...
- **Throughput:** > 620 requests per second
- **Concurrent Users:** Support for 1671 concurrent users
- **Resource Usage:** < 80% CPU, < 77% memory
