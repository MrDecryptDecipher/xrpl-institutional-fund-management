# Advanced Test Scenario - EDGE-CASES_AUTHENTICATION-EDGE-CASES_0030

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_AUTHENTICATION-EDGE-CASES_0030
- **Category:** edge-cases
- **Subcategory:** authentication-edge-cases
- **Scenario Number:** 30
- **Created:** 2025-10-11T21:28:31.397Z
- **Complexity:** SIMPLE
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 20930,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.397Z"
    }
  ]
}
```
...
- **Latency:** 465ms average response time
...
- **Throughput:** > 602 requests per second
- **Concurrent Users:** Support for 1363 concurrent users
