# Advanced Test Scenario - EDGE-CASES_TIME-ZONE-EDGE-CASES_0022

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TIME-ZONE-EDGE-CASES_0022
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 747 operations per second
...
- **Concurrent Users:** Support for 1018 concurrent users
- **Resource Usage:** < 84% CPU, < 81% memory
