# Advanced Test Scenario - EDGE-CASES_TIME-ZONE-EDGE-CASES_0008

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TIME-ZONE-EDGE-CASES_0008
- **Category:** edge-cases
- **Subcategory:** time-zone-edge-cases
- **Scenario Number:** 8
- **Created:** 2025-10-11T21:28:31.350Z
  ...
  "transactions": [
    {
      ...
      "amount": 16424,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.350Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 542 operations per second
...
- **Concurrent Users:** Support for 1610 concurrent users
