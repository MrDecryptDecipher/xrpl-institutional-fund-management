# Advanced Test Scenario - COMPLIANCE-SCENARIOS_FINMA-COMPLIANCE-SCENARIOS_0008

## Scenario Metadata
- **Scenario ID:** COMPLIANCE-SCENARIOS_FINMA-COMPLIANCE-SCENARIOS_0008
- **Category:** compliance-scenarios
- **Subcategory:** finma-compliance-scenarios
- **Scenario Number:** 8
- **Created:** 2025-10-11T21:28:31.585Z
  ...
  "transactions": [
    {
      ...
      "amount": 77300,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.585Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 969 operations per second
...
- **Concurrent Users:** Support for 1995 concurrent users
