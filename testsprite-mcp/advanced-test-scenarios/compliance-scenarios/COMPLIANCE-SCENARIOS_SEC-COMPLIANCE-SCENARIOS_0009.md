# Advanced Test Scenario - COMPLIANCE-SCENARIOS_SEC-COMPLIANCE-SCENARIOS_0009

## Scenario Metadata
- **Scenario ID:** COMPLIANCE-SCENARIOS_SEC-COMPLIANCE-SCENARIOS_0009
- **Category:** compliance-scenarios
- **Subcategory:** sec-compliance-scenarios
- **Scenario Number:** 9
- **Created:** 2025-10-11T21:28:31.592Z
  ...
  "transactions": [
    {
      ...
      "amount": 3483,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.592Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1860 concurrent users
- **Resource Usage:** < 88% CPU, < 86% memory
