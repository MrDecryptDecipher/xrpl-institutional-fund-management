# Advanced Test Scenario - ERROR-SCENARIOS_AUTHENTICATION-ERROR-SCENARIOS_0021

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_AUTHENTICATION-ERROR-SCENARIOS_0021
- **Category:** error-scenarios
- **Subcategory:** authentication-error-scenarios
- **Scenario Number:** 21
- **Created:** 2025-10-11T21:28:31.423Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 10504,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.423Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1312 concurrent users
