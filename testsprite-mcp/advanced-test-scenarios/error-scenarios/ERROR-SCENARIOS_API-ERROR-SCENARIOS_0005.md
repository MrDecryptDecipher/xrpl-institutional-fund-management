# Advanced Test Scenario - ERROR-SCENARIOS_API-ERROR-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_API-ERROR-SCENARIOS_0005
- **Category:** error-scenarios
- **Subcategory:** api-error-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.417Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 34351,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.417Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1603 concurrent users
