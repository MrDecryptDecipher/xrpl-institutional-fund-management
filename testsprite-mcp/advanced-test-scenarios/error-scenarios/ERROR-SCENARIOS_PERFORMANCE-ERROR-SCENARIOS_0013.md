# Advanced Test Scenario - ERROR-SCENARIOS_PERFORMANCE-ERROR-SCENARIOS_0013

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_PERFORMANCE-ERROR-SCENARIOS_0013
- **Category:** error-scenarios
- **Subcategory:** performance-error-scenarios
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.493Z
  ...
  "transactions": [
    {
      ...
      "amount": 79870,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.493Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 267 operations per second
