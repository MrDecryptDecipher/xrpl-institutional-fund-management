# Advanced Test Scenario - ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0025

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0025
- **Category:** error-scenarios
- **Subcategory:** authorization-error-scenarios
- **Scenario Number:** 25
- **Created:** 2025-10-11T21:28:31.428Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 58129,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.428Z"
    }
  ]
}
```
...
- **Throughput:** > 799 requests per second
- **Concurrent Users:** Support for 1503 concurrent users
- **Resource Usage:** < 71% CPU, < 84% memory
