# Advanced Test Scenario - ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0005
- **Category:** error-scenarios
- **Subcategory:** authorization-error-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.426Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 62278,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.426Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 201 operations per second
