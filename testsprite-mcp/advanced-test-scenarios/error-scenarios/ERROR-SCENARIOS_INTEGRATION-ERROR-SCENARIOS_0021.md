# Advanced Test Scenario - ERROR-SCENARIOS_INTEGRATION-ERROR-SCENARIOS_0021

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_INTEGRATION-ERROR-SCENARIOS_0021
- **Category:** error-scenarios
- **Subcategory:** integration-error-scenarios
- **Scenario Number:** 21
- **Created:** 2025-10-11T21:28:31.447Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 60625,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.447Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1445 concurrent users
