# Advanced Test Scenario - ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0045

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0045
- **Category:** error-scenarios
- **Subcategory:** business-logic-error-scenarios
- **Scenario Number:** 45
- **Created:** 2025-10-11T21:28:31.442Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 88100,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.442Z"
    }
  ]
}
```
...
- **Resource Usage:** < 72% CPU, < 74% memory
