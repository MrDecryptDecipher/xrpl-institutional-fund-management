# Advanced Test Scenario - ERROR-SCENARIOS_SECURITY-ERROR-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_SECURITY-ERROR-SCENARIOS_0005
- **Category:** error-scenarios
- **Subcategory:** security-error-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.481Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 1044,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.481Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 820 operations per second
