# Developer-guides Documentation - DEVELOPER-GUIDES_GETTING-STARTED_0008

## Document Metadata
- **Document ID:** DEVELOPER-GUIDES_GETTING-STARTED_0008
- **Category:** developer-guides
- **Subcategory:** getting-started
- **Document Number:** 8
- **Created:** 2025-10-11T21:19:05.984Z
- **Last Updated:** 2025-10-11T21:19:05.984Z
- **Version:** 1.0.0
- **Status:** DRAFT
- **Complexity:** BASIC
...
## Introduction
### Purpose
This document provides comprehensive documentation for the getting-started component of the XRPL Institutional Fund Management Protocol. It serves as a complete reference for developers, administrators, and users working with this system.

### Scope
The documentation covers all aspects of getting-started including technical specifications, implementation details, configuration options, usage examples, and best practices.
...
## Technical Overview
### System Architecture
The getting-started component is built using modern microservices architecture with the following key characteristics:
...
PUT /api/getting-started/{id}
DELETE /api/getting-started/{id}
```
...
### Basic Usage
```typescript
import { getting-startedService } from './services/getting-started';

// Initialize service
const service = new getting-startedService();
