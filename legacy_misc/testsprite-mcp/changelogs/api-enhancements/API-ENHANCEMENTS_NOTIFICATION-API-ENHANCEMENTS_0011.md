# Changelog - API-ENHANCEMENTS_NOTIFICATION-API-ENHANCEMENTS_0011

## Changelog Metadata
- **Changelog ID:** API-ENHANCEMENTS_NOTIFICATION-API-ENHANCEMENTS_0011
...
- **Throughput:** 71% increase in requests per second
