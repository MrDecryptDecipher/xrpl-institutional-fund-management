# Changelog - API-ENHANCEMENTS_REPORTING-API-ENHANCEMENTS_0002

## Changelog Metadata
- **Changelog ID:** API-ENHANCEMENTS_REPORTING-API-ENHANCEMENTS_0002
...
- **Throughput:** 86% increase in transaction processing capacity
...
- **Throughput:** 73% increase in requests per second
