# Advanced Test Scenario - COMPLIANCE-SCENARIOS_SEC-COMPLIANCE-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** COMPLIANCE-SCENARIOS_SEC-COMPLIANCE-SCENARIOS_0005
- **Category:** compliance-scenarios
- **Subcategory:** sec-compliance-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.589Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 52538,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.589Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1090 concurrent users
