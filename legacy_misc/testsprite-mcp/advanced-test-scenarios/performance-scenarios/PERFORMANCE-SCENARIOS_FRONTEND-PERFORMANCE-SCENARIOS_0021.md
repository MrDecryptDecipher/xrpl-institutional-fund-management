# Advanced Test Scenario - PERFORMANCE-SCENARIOS_FRONTEND-PERFORMANCE-SCENARIOS_0021

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_FRONTEND-PERFORMANCE-SCENARIOS_0021
- **Category:** performance-scenarios
- **Subcategory:** frontend-performance-scenarios
- **Scenario Number:** 21
- **Created:** 2025-10-11T21:28:31.541Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 77911,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.541Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 1088 operations per second
...
- **Concurrent Users:** Support for 1569 concurrent users
- **Resource Usage:** < 87% CPU, < 70% memory
