# Advanced Test Scenario - PERFORMANCE-SCENARIOS_DATABASE-PERFORMANCE-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** PERFORMANCE-SCENARIOS_DATABASE-PERFORMANCE-SCENARIOS_0005
- **Category:** performance-scenarios
- **Subcategory:** database-performance-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.534Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 29719,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.534Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1055 concurrent users
- **Resource Usage:** < 74% CPU, < 76% memory
