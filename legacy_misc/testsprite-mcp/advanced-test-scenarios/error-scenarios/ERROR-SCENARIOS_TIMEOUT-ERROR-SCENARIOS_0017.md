# Advanced Test Scenario - ERROR-SCENARIOS_TIMEOUT-ERROR-SCENARIOS_0017

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_TIMEOUT-ERROR-SCENARIOS_0017
- **Category:** error-scenarios
- **Subcategory:** timeout-error-scenarios
- **Scenario Number:** 17
- **Created:** 2025-10-11T21:28:31.464Z
- **Complexity:** COMPLEX
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 85852,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.464Z"
    }
  ]
}
```
...
- **Throughput:** > 730 requests per second
- **Concurrent Users:** Support for 1617 concurrent users
- **Resource Usage:** < 85% CPU, < 78% memory
