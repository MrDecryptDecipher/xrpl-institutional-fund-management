# Advanced Test Scenario - ERROR-SCENARIOS_SYSTEM-FAILURE-SCENARIOS_0026

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_SYSTEM-FAILURE-SCENARIOS_0026
- **Category:** error-scenarios
- **Subcategory:** system-failure-scenarios
- **Scenario Number:** 26
- **Created:** 2025-10-11T21:28:31.500Z
- **Complexity:** MODERATE
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 83140,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.500Z"
    }
  ]
}
```
...
- **Throughput:** > 938 requests per second
- **Concurrent Users:** Support for 1358 concurrent users
- **Resource Usage:** < 82% CPU, < 87% memory
