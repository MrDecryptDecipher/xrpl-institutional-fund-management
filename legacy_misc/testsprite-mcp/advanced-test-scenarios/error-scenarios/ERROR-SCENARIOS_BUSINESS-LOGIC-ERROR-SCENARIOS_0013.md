# Advanced Test Scenario - ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0013

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0013
- **Category:** error-scenarios
- **Subcategory:** business-logic-error-scenarios
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.438Z
  ...
  "transactions": [
    {
      ...
      "amount": 97538,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.438Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 177 operations per second
