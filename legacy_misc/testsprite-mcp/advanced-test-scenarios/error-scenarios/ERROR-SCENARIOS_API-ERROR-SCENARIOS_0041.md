# Advanced Test Scenario - ERROR-SCENARIOS_API-ERROR-SCENARIOS_0041

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_API-ERROR-SCENARIOS_0041
- **Category:** error-scenarios
- **Subcategory:** api-error-scenarios
- **Scenario Number:** 41
- **Created:** 2025-10-11T21:28:31.420Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 80155,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.420Z"
    }
  ]
}
```
...
- **Concurrent Users:** Support for 1411 concurrent users
