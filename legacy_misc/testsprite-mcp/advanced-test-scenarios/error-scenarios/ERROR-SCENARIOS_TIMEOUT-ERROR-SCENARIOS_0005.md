# Advanced Test Scenario - ERROR-SCENARIOS_TIMEOUT-ERROR-SCENARIOS_0005

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_TIMEOUT-ERROR-SCENARIOS_0005
- **Category:** error-scenarios
- **Subcategory:** timeout-error-scenarios
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.460Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 8833,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.460Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 665 operations per second
