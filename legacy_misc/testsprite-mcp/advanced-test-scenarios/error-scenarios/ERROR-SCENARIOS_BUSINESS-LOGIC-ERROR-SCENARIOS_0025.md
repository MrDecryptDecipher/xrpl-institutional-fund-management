# Advanced Test Scenario - ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0025

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_BUSINESS-LOGIC-ERROR-SCENARIOS_0025
- **Category:** error-scenarios
- **Subcategory:** business-logic-error-scenarios
- **Scenario Number:** 25
- **Created:** 2025-10-11T21:28:31.440Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 72276,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.440Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 1005 operations per second
...
- **MTBF (Mean Time Between Failures):** 268 hours
