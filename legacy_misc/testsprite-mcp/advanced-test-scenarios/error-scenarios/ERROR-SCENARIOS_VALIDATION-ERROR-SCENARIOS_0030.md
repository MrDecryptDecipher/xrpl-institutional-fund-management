# Advanced Test Scenario - ERROR-SCENARIOS_VALIDATION-ERROR-SCENARIOS_0030

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_VALIDATION-ERROR-SCENARIOS_0030
- **Category:** error-scenarios
- **Subcategory:** validation-error-scenarios
- **Scenario Number:** 30
- **Created:** 2025-10-11T21:28:31.435Z
- **Complexity:** SIMPLE
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 61707,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.435Z"
    }
  ]
}
```
...
- **MTBF (Mean Time Between Failures):** 324 hours
