# Advanced Test Scenario - ERROR-SCENARIOS_SYSTEM-FAILURE-SCENARIOS_0013

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_SYSTEM-FAILURE-SCENARIOS_0013
- **Category:** error-scenarios
- **Subcategory:** system-failure-scenarios
- **Scenario Number:** 13
- **Created:** 2025-10-11T21:28:31.497Z
  ...
  "transactions": [
    {
      ...
      "amount": 99538,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.497Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 455 operations per second
...
- **Concurrent Users:** Support for 1225 concurrent users
- **Resource Usage:** < 84% CPU, < 87% memory
