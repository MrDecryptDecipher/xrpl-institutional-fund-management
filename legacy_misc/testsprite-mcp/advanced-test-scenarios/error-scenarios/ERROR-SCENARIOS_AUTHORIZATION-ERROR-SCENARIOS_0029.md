# Advanced Test Scenario - ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0029

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0029
- **Category:** error-scenarios
- **Subcategory:** authorization-error-scenarios
- **Scenario Number:** 29
- **Created:** 2025-10-11T21:28:31.429Z
  ...
  "transactions": [
    {
      ...
      "amount": 51028,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.429Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 1044 operations per second
...
- **Concurrent Users:** Support for 1230 concurrent users
