# Advanced Test Scenario - ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0038

## Scenario Metadata
- **Scenario ID:** ERROR-SCENARIOS_AUTHORIZATION-ERROR-SCENARIOS_0038
- **Category:** error-scenarios
- **Subcategory:** authorization-error-scenarios
- **Scenario Number:** 38
- **Created:** 2025-10-11T21:28:31.430Z
  ...
  "transactions": [
    {
      ...
      "amount": 48093,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.430Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 118 operations per second
...
- **Concurrent Users:** Support for 1425 concurrent users
