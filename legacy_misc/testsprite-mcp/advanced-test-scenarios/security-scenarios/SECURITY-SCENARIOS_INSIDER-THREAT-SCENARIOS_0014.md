# Advanced Test Scenario - SECURITY-SCENARIOS_INSIDER-THREAT-SCENARIOS_0014

## Scenario Metadata
- **Scenario ID:** SECURITY-SCENARIOS_INSIDER-THREAT-SCENARIOS_0014
- **Category:** security-scenarios
- **Subcategory:** insider-threat-scenarios
- **Scenario Number:** 14
- **Created:** 2025-10-11T21:28:31.579Z
...
# Test environment configuration
environment:
  name: insider-threat-scenarios-test-env
  type: production
  region: us-east-1
  ...
  "transactions": [
    {
      ...
      "amount": 77899,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.579Z"
    }
  ]
}
```
...
alerts:
  - name: insider-threat-scenarios_performance_degradation
    condition: response_time > 2s
    duration: 5m
    severity: warning
    action: notify_team
    
  - name: insider-threat-scenarios_error_rate_high
...
describe('insider-threat-scenarios Integration Test', () => {
  test('should handle insider-threat-scenarios operations correctly', async () => {
    // Test implementation
    const result = await insider-threat-scenariosService.performOperation(testData);
