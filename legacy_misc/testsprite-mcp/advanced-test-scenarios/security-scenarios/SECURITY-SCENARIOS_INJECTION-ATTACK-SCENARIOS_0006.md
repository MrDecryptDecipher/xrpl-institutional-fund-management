# Advanced Test Scenario - SECURITY-SCENARIOS_INJECTION-ATTACK-SCENARIOS_0006

## Scenario Metadata
- **Scenario ID:** SECURITY-SCENARIOS_INJECTION-ATTACK-SCENARIOS_0006
- **Category:** security-scenarios
- **Subcategory:** injection-attack-scenarios
- **Scenario Number:** 6
- **Created:** 2025-10-11T21:28:31.560Z
- **Complexity:** MODERATE
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 9675,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.560Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 323 operations per second
