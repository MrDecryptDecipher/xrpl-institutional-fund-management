# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0030

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0030
...
- **Latency:** 412ms average response time
...
### Performance Targets
- **Response Time:** < 119ms for 95th percentile
- **Throughput:** > 954 requests per second
- **Concurrent Users:** Support for 1252 concurrent users
- **Resource Usage:** < 76% CPU, < 83% memory
...
- 99th Percentile: 723ms
- Throughput: 804 RPS
- Concurrent Users: 1968
```
...
- **MTTR (Mean Time To Recovery):** 84 minutes
- **MTBF (Mean Time Between Failures):** 285 hours
