# Advanced Test Scenario - COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0006

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0006
...
### Performance Results
- **Throughput:** 766 operations per second
...
- **Throughput:** > 866 requests per second
- **Concurrent Users:** Support for 1188 concurrent users
- **Resource Usage:** < 81% CPU, < 88% memory
...
- **MTTR (Mean Time To Recovery):** 116 minutes
