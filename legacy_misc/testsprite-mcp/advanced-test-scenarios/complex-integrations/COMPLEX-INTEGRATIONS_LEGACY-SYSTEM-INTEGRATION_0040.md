# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0040

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0040
...
### Performance Results
- **Throughput:** 956 operations per second
...
- **Throughput:** > 810 requests per second
- **Concurrent Users:** Support for 1315 concurrent users
- **Resource Usage:** < 87% CPU, < 79% memory
...
- **MTTR (Mean Time To Recovery):** 99 minutes
- **MTBF (Mean Time Between Failures):** 432 hours
