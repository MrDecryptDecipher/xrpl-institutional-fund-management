# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0019

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0019
...
### Performance Results
- **Throughput:** 268 operations per second
...
### Performance Targets
- **Response Time:** < 152ms for 95th percentile
- **Throughput:** > 972 requests per second
- **Concurrent Users:** Support for 1112 concurrent users
...
- 95th Percentile: 506ms
- 99th Percentile: 750ms
- Throughput: 728 RPS
- Concurrent Users: 1185
```
...
- **MTBF (Mean Time Between Failures):** 813 hours
