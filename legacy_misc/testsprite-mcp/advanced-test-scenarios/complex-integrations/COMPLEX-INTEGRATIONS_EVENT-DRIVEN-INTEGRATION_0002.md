# Advanced Test Scenario - COMPLEX-INTEGRATIONS_EVENT-DRIVEN-INTEGRATION_0002

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_EVENT-DRIVEN-INTEGRATION_0002
...
### Performance Results
- **Throughput:** 383 operations per second
...
### Performance Targets
- **Response Time:** < 254ms for 95th percentile
- **Throughput:** > 649 requests per second
- **Concurrent Users:** Support for 1249 concurrent users
- **Resource Usage:** < 75% CPU, < 89% memory
...
- 99th Percentile: 615ms
- Throughput: 527 RPS
- Concurrent Users: 1342
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 57 minutes
- **RPO (Recovery Point Objective):** 24 minutes
- **MTTR (Mean Time To Recovery):** 117 minutes
- **MTBF (Mean Time Between Failures):** 656 hours
