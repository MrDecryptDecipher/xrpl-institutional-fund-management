# Advanced Test Scenario - COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0020

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0020
...
### Performance Results
- **Throughput:** 590 operations per second
...
- **Throughput:** > 874 requests per second
- **Concurrent Users:** Support for 1351 concurrent users
- **Resource Usage:** < 74% CPU, < 89% memory
...
- **MTTR (Mean Time To Recovery):** 111 minutes
- **MTBF (Mean Time Between Failures):** 356 hours
