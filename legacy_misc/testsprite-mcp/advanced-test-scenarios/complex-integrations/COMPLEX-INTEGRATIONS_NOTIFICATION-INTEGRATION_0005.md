# Advanced Test Scenario - COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0005

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0005
...
### Performance Results
- **Throughput:** 867 operations per second
- **Latency:** 310ms average response time
...
### Performance Targets
- **Response Time:** < 186ms for 95th percentile
- **Throughput:** > 862 requests per second
- **Concurrent Users:** Support for 1299 concurrent users
...
- **MTTR (Mean Time To Recovery):** 138 minutes
- **MTBF (Mean Time Between Failures):** 220 hours
