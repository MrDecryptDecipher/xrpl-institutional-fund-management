# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0034

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0034
...
### Performance Results
- **Throughput:** 276 operations per second
...
- **Throughput:** > 591 requests per second
- **Concurrent Users:** Support for 1532 concurrent users
- **Resource Usage:** < 85% CPU, < 71% memory
