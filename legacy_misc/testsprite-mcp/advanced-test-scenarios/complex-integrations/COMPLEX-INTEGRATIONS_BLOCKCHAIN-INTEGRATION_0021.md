# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0021

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0021
...
### Performance Results
- **Throughput:** 944 operations per second
...
- **Throughput:** > 974 requests per second
- **Concurrent Users:** Support for 1114 concurrent users
- **Resource Usage:** < 77% CPU, < 74% memory
