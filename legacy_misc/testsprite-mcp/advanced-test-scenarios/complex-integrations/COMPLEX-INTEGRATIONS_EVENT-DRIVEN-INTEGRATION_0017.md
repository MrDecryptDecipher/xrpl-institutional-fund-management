# Advanced Test Scenario - COMPLEX-INTEGRATIONS_EVENT-DRIVEN-INTEGRATION_0017

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_EVENT-DRIVEN-INTEGRATION_0017
  ...
  "transactions": [
    {
      ...
      "amount": 59373,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.220Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 407 operations per second
- **Latency:** 214ms average response time
...
### Performance Targets
- **Response Time:** < 173ms for 95th percentile
- **Throughput:** > 574 requests per second
- **Concurrent Users:** Support for 1378 concurrent users
- **Resource Usage:** < 79% CPU, < 80% memory
...
- 95th Percentile: 242ms
- 99th Percentile: 471ms
- Throughput: 552 RPS
- Concurrent Users: 1587
```
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 56 minutes
- **RPO (Recovery Point Objective):** 16 minutes
- **MTTR (Mean Time To Recovery):** 56 minutes
