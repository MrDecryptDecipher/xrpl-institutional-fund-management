# Advanced Test Scenario - COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0021

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_NOTIFICATION-INTEGRATION_0021
...
### Performance Results
- **Throughput:** 1077 operations per second
...
- **Throughput:** > 769 requests per second
- **Concurrent Users:** Support for 1028 concurrent users
- **Resource Usage:** < 73% CPU, < 78% memory
