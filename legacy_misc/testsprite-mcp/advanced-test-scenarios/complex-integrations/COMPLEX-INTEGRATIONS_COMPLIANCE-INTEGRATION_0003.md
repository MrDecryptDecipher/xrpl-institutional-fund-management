# Advanced Test Scenario - COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0003

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0003
- **Category:** complex-integrations
- **Subcategory:** compliance-integration
- **Scenario Number:** 3
- **Created:** 2025-10-11T21:28:31.251Z
  ...
  "transactions": [
    {
      ...
      "amount": 96181,
      "status": "failed",
      "timestamp": "2025-10-11T21:28:31.251Z"
    }
  ]
}
```
...
- **Latency:** 493ms average response time
...
- **Throughput:** > 847 requests per second
- **Concurrent Users:** Support for 1186 concurrent users
...
### Recovery Timeframes
- **RTO (Recovery Time Objective):** 28 minutes
