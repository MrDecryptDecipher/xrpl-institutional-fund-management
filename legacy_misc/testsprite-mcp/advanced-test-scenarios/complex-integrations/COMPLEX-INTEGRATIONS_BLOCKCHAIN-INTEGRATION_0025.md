# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0025

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BLOCKCHAIN-INTEGRATION_0025
...
### Performance Results
- **Throughput:** 714 operations per second
...
### Performance Targets
- **Response Time:** < 139ms for 95th percentile
- **Throughput:** > 672 requests per second
- **Concurrent Users:** Support for 1965 concurrent users
- **Resource Usage:** < 75% CPU, < 86% memory
...
- 99th Percentile: 636ms
- Throughput: 788 RPS
- Concurrent Users: 1403
```
...
- **MTTR (Mean Time To Recovery):** 48 minutes
