# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0030

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0030
...
### Performance Results
- **Throughput:** 288 operations per second
- **Latency:** 541ms average response time
...
### Performance Targets
- **Response Time:** < 114ms for 95th percentile
- **Throughput:** > 934 requests per second
- **Concurrent Users:** Support for 1404 concurrent users
- **Resource Usage:** < 71% CPU, < 78% memory
...
- 99th Percentile: 744ms
- Throughput: 501 RPS
- Concurrent Users: 1337
```
...
- **MTBF (Mean Time Between Failures):** 618 hours
