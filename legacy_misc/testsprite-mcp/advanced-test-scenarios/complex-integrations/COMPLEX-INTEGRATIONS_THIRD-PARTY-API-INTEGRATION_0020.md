# Advanced Test Scenario - COMPLEX-INTEGRATIONS_THIRD-PARTY-API-INTEGRATION_0020

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_THIRD-PARTY-API-INTEGRATION_0020
...
- **Throughput:** > 970 requests per second
- **Concurrent Users:** Support for 1524 concurrent users
- **Resource Usage:** < 89% CPU, < 81% memory
...
- 95th Percentile: 442ms
- 99th Percentile: 864ms
- Throughput: 872 RPS
- Concurrent Users: 1907
```
...
- **MTTR (Mean Time To Recovery):** 39 minutes
