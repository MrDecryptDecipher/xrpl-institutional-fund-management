# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0038

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0038
...
### Performance Results
- **Throughput:** 850 operations per second
...
- **Throughput:** > 863 requests per second
- **Concurrent Users:** Support for 1991 concurrent users
- **Resource Usage:** < 71% CPU, < 73% memory
