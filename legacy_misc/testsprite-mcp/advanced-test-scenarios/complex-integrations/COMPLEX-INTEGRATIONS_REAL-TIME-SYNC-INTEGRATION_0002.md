# Advanced Test Scenario - COMPLEX-INTEGRATIONS_REAL-TIME-SYNC-INTEGRATION_0002

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_REAL-TIME-SYNC-INTEGRATION_0002
...
- **Latency:** 155ms average response time
...
- **Throughput:** > 961 requests per second
- **Concurrent Users:** Support for 1506 concurrent users
- **Resource Usage:** < 86% CPU, < 71% memory
...
- 95th Percentile: 534ms
- 99th Percentile: 300ms
- Throughput: 594 RPS
- Concurrent Users: 1875
```
...
- **MTTR (Mean Time To Recovery):** 108 minutes
- **MTBF (Mean Time Between Failures):** 664 hours
