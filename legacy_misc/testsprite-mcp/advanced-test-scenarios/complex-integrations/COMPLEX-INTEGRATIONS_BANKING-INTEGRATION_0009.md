# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0009

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0009
- **Category:** complex-integrations
- **Subcategory:** banking-integration
- **Scenario Number:** 9
- **Created:** 2025-10-11T21:28:31.246Z
  ...
  "transactions": [
    {
      ...
      "amount": 45454,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.246Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 568 operations per second
- **Latency:** 537ms average response time
...
### Performance Targets
- **Response Time:** < 170ms for 95th percentile
- **Throughput:** > 983 requests per second
- **Concurrent Users:** Support for 1451 concurrent users
- **Resource Usage:** < 74% CPU, < 82% memory
...
- 99th Percentile: 786ms
- Throughput: 946 RPS
- Concurrent Users: 1469
```
...
- **MTTR (Mean Time To Recovery):** 37 minutes
- **MTBF (Mean Time Between Failures):** 658 hours
