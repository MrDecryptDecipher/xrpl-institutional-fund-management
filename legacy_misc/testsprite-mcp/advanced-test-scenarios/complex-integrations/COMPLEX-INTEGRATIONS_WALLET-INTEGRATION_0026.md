# Advanced Test Scenario - COMPLEX-INTEGRATIONS_WALLET-INTEGRATION_0026

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_WALLET-INTEGRATION_0026
...
### Performance Results
- **Throughput:** 237 operations per second
...
- **Throughput:** > 753 requests per second
- **Concurrent Users:** Support for 1856 concurrent users
- **Resource Usage:** < 77% CPU, < 79% memory
...
- 95th Percentile: 596ms
- 99th Percentile: 639ms
- Throughput: 598 RPS
- Concurrent Users: 1737
```
...
- **MTBF (Mean Time Between Failures):** 374 hours
