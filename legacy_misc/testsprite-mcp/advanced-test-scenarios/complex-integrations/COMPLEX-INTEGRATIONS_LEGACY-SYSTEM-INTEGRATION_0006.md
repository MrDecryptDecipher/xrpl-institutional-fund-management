# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0006

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0006
...
### Performance Targets
- **Response Time:** < 158ms for 95th percentile
- **Throughput:** > 908 requests per second
- **Concurrent Users:** Support for 1547 concurrent users
- **Resource Usage:** < 85% CPU, < 79% memory
...
- 99th Percentile: 432ms
- Throughput: 973 RPS
- Concurrent Users: 1109
```
...
- **MTBF (Mean Time Between Failures):** 416 hours
