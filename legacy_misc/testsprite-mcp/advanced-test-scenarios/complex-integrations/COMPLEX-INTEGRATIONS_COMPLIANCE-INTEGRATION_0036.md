# Advanced Test Scenario - COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0036

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_COMPLIANCE-INTEGRATION_0036
...
### Performance Results
- **Throughput:** 868 operations per second
...
- **Throughput:** > 881 requests per second
- **Concurrent Users:** Support for 1683 concurrent users
- **Resource Usage:** < 70% CPU, < 73% memory
