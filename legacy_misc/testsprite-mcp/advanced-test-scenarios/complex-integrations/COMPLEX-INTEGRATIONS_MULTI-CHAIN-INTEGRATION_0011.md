# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MULTI-CHAIN-INTEGRATION_0011

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MULTI-CHAIN-INTEGRATION_0011
- **Category:** complex-integrations
- **Subcategory:** multi-chain-integration
- **Scenario Number:** 11
- **Created:** 2025-10-11T21:28:31.194Z
- **Complexity:** MODERATE
- **Risk Level:** CRITICAL
  ...
  "transactions": [
    {
      ...
      "amount": 33617,
      "status": "failed",
      "timestamp": "2025-10-11T21:28:31.194Z"
    }
  ]
}
```
...
- **Latency:** 506ms average response time
...
- **Throughput:** > 615 requests per second
- **Concurrent Users:** Support for 1421 concurrent users
