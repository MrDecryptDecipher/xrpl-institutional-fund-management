# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0023

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MICROSERVICES-INTEGRATION_0023
...
### Performance Results
- **Throughput:** 232 operations per second
- **Latency:** 413ms average response time
...
- **Throughput:** > 959 requests per second
- **Concurrent Users:** Support for 1430 concurrent users
