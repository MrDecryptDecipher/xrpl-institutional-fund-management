# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0036

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0036
...
### Performance Results
- **Throughput:** 444 operations per second
- **Latency:** 90ms average response time
...
- **Throughput:** > 543 requests per second
- **Concurrent Users:** Support for 1970 concurrent users
- **Resource Usage:** < 86% CPU, < 85% memory
...
- 99th Percentile: 555ms
- Throughput: 727 RPS
- Concurrent Users: 1114
```
...
- **MTBF (Mean Time Between Failures):** 412 hours
