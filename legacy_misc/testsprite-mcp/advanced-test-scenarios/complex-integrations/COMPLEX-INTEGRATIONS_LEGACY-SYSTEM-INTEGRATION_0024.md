# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0024

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0024
...
### Performance Results
- **Throughput:** 1037 operations per second
...
- **Throughput:** > 569 requests per second
- **Concurrent Users:** Support for 1601 concurrent users
- **Resource Usage:** < 88% CPU, < 80% memory
...
- 95th Percentile: 384ms
- 99th Percentile: 429ms
- Throughput: 624 RPS
- Concurrent Users: 1526
```
...
- **MTTR (Mean Time To Recovery):** 144 minutes
- **MTBF (Mean Time Between Failures):** 713 hours
