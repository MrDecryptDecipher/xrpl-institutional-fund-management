# Advanced Test Scenario - COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0034

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_MARKET-DATA-INTEGRATION_0034
- **Category:** complex-integrations
- **Subcategory:** market-data-integration
- **Scenario Number:** 34
- **Created:** 2025-10-11T21:28:31.259Z
  ...
  "transactions": [
    {
      ...
      "amount": 44110,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.259Z"
    }
  ]
}
```
...
- **Latency:** 546ms average response time
...
### Performance Targets
- **Response Time:** < 146ms for 95th percentile
- **Throughput:** > 822 requests per second
- **Concurrent Users:** Support for 1346 concurrent users
- **Resource Usage:** < 72% CPU, < 71% memory
...
- **MTTR (Mean Time To Recovery):** 147 minutes
- **MTBF (Mean Time Between Failures):** 858 hours
