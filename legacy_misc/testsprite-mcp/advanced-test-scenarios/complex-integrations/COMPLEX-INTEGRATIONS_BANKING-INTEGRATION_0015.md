# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0015

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0015
...
- **Latency:** 213ms average response time
...
- **Throughput:** > 772 requests per second
- **Concurrent Users:** Support for 1441 concurrent users
- **Resource Usage:** < 81% CPU, < 78% memory
...
- **MTBF (Mean Time Between Failures):** 223 hours
