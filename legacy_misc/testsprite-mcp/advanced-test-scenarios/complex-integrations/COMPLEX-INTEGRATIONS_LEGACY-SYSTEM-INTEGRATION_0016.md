# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0016

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0016
...
### Performance Results
- **Throughput:** 786 operations per second
- **Latency:** 98ms average response time
...
- **Throughput:** > 685 requests per second
- **Concurrent Users:** Support for 1523 concurrent users
- **Resource Usage:** < 86% CPU, < 81% memory
...
- 95th Percentile: 432ms
- 99th Percentile: 630ms
- Throughput: 633 RPS
- Concurrent Users: 1300
```
...
- **MTTR (Mean Time To Recovery):** 103 minutes
- **MTBF (Mean Time Between Failures):** 363 hours
