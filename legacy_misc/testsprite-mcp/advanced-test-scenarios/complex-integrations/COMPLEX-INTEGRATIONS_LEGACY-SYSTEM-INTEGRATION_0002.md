# Advanced Test Scenario - COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0002

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_LEGACY-SYSTEM-INTEGRATION_0002
...
### Performance Results
- **Throughput:** 143 operations per second
...
### Performance Targets
- **Response Time:** < 226ms for 95th percentile
- **Throughput:** > 742 requests per second
- **Concurrent Users:** Support for 1491 concurrent users
- **Resource Usage:** < 77% CPU, < 82% memory
...
- **MTBF (Mean Time Between Failures):** 335 hours
