# Advanced Test Scenario - COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0008

## Scenario Metadata
- **Scenario ID:** COMPLEX-INTEGRATIONS_BANKING-INTEGRATION_0008
...
### Performance Results
- **Throughput:** 289 operations per second
- **Latency:** 419ms average response time
...
### Performance Targets
- **Response Time:** < 113ms for 95th percentile
- **Throughput:** > 962 requests per second
- **Concurrent Users:** Support for 1471 concurrent users
...
- 95th Percentile: 590ms
- 99th Percentile: 447ms
- Throughput: 655 RPS
- Concurrent Users: 1670
```
...
- **MTBF (Mean Time Between Failures):** 436 hours
