# Advanced Test Scenario - EDGE-CASES_SYSTEM-RESOURCE-EDGE-CASES_0020

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_SYSTEM-RESOURCE-EDGE-CASES_0020
- **Category:** edge-cases
...
- **Throughput:** > 586 requests per second
- **Concurrent Users:** Support for 1108 concurrent users
- **Resource Usage:** < 82% CPU, < 78% memory
