# Advanced Test Scenario - EDGE-CASES_TRANSACTION-EDGE-CASES_0005

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TRANSACTION-EDGE-CASES_0005
- **Category:** edge-cases
- **Subcategory:** transaction-edge-cases
- **Scenario Number:** 5
- **Created:** 2025-10-11T21:28:31.378Z
- **Complexity:** SIMPLE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 91109,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.378Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 139 operations per second
...
- **Throughput:** > 539 requests per second
- **Concurrent Users:** Support for 1512 concurrent users
- **Resource Usage:** < 72% CPU, < 70% memory
...
- **MTBF (Mean Time Between Failures):** 315 hours
