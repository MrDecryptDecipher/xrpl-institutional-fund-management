# Advanced Test Scenario - EDGE-CASES_AUTHORIZATION-EDGE-CASES_0029

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_AUTHORIZATION-EDGE-CASES_0029
- **Category:** edge-cases
...
- **Throughput:** > 790 requests per second
- **Concurrent Users:** Support for 1028 concurrent users
- **Resource Usage:** < 79% CPU, < 78% memory
