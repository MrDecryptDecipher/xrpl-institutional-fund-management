# Advanced Test Scenario - EDGE-CASES_PERFORMANCE-EDGE-CASES_0028

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_PERFORMANCE-EDGE-CASES_0028
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 851 operations per second
- **Latency:** 315ms average response time
...
- **Throughput:** > 763 requests per second
- **Concurrent Users:** Support for 1714 concurrent users
- **Resource Usage:** < 86% CPU, < 70% memory
...
- 99th Percentile: 885ms
- Throughput: 705 RPS
- Concurrent Users: 1708
```
