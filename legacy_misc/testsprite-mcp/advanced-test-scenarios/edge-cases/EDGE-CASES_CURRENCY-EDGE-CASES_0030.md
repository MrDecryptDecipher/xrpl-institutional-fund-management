# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0030

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0030
- **Category:** edge-cases
- **Subcategory:** currency-edge-cases
- **Scenario Number:** 30
- **Created:** 2025-10-11T21:28:31.374Z
- **Complexity:** SIMPLE
- **Risk Level:** HIGH
  ...
  "transactions": [
    {
      ...
      "amount": 54891,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.374Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 335 operations per second
- **Latency:** 104ms average response time
...
- **Concurrent Users:** Support for 1443 concurrent users
...
- **MTBF (Mean Time Between Failures):** 222 hours
