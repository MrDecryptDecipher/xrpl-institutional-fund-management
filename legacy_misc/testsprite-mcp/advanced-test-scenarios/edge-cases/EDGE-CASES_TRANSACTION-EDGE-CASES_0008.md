# Advanced Test Scenario - EDGE-CASES_TRANSACTION-EDGE-CASES_0008

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_TRANSACTION-EDGE-CASES_0008
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 673 operations per second
- **Latency:** 516ms average response time
...
- **Throughput:** > 634 requests per second
- **Concurrent Users:** Support for 1366 concurrent users
- **Resource Usage:** < 78% CPU, < 79% memory
...
- **MTBF (Mean Time Between Failures):** 392 hours
