# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0020

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0020
- **Category:** edge-cases
- **Subcategory:** currency-edge-cases
- **Scenario Number:** 20
- **Created:** 2025-10-11T21:28:31.372Z
- **Complexity:** SIMPLE
- **Risk Level:** LOW
  ...
  "transactions": [
    {
      ...
      "amount": 26288,
      "status": "pending",
      "timestamp": "2025-10-11T21:28:31.372Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 788 operations per second
...
- **Throughput:** > 549 requests per second
- **Concurrent Users:** Support for 1381 concurrent users
- **Resource Usage:** < 75% CPU, < 82% memory
...
- 99th Percentile: 609ms
- Throughput: 731 RPS
- Concurrent Users: 1572
```
