# Advanced Test Scenario - EDGE-CASES_USER-INPUT-EDGE-CASES_0018

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_USER-INPUT-EDGE-CASES_0018
- **Category:** edge-cases
- **Subcategory:** user-input-edge-cases
- **Scenario Number:** 18
- **Created:** 2025-10-11T21:28:31.333Z
  ...
  "transactions": [
    {
      ...
      "amount": 67077,
      "status": "completed",
      "timestamp": "2025-10-11T21:28:31.333Z"
    }
  ]
}
```
...
- **Latency:** 441ms average response time
...
- **Throughput:** > 735 requests per second
- **Concurrent Users:** Support for 1650 concurrent users
- **Resource Usage:** < 82% CPU, < 71% memory
...
- 95th Percentile: 262ms
- 99th Percentile: 555ms
- Throughput: 519 RPS
- Concurrent Users: 1317
```
...
- **MTBF (Mean Time Between Failures):** 638 hours
