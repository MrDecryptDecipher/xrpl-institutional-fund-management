# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0013

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0013
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 655 operations per second
- **Latency:** 486ms average response time
...
- **Concurrent Users:** Support for 1819 concurrent users
...
- **MTBF (Mean Time Between Failures):** 779 hours
