# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0001

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0001
- **Category:** edge-cases
- **Subcategory:** currency-edge-cases
- **Scenario Number:** 1
- **Created:** 2025-10-11T21:28:31.362Z
- **Complexity:** MODERATE
- **Risk Level:** MEDIUM
  ...
  "transactions": [
    {
      ...
      "amount": 61465,
      "status": "processing",
      "timestamp": "2025-10-11T21:28:31.362Z"
    }
  ]
}
```
...
### Performance Results
- **Throughput:** 211 operations per second
...
- **Concurrent Users:** Support for 1257 concurrent users
...
- **MTBF (Mean Time Between Failures):** 372 hours
