# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0016

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0016
- **Category:** edge-cases
...
### Performance Results
- **Throughput:** 567 operations per second
- **Latency:** 479ms average response time
...
- **Concurrent Users:** Support for 1608 concurrent users
...
- 99th Percentile: 759ms
- Throughput: 806 RPS
- Concurrent Users: 1558
```
...
- **MTBF (Mean Time Between Failures):** 244 hours
