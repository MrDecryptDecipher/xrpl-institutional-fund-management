# Advanced Test Scenario - EDGE-CASES_CURRENCY-EDGE-CASES_0010

## Scenario Metadata
- **Scenario ID:** EDGE-CASES_CURRENCY-EDGE-CASES_0010
- **Category:** edge-cases
- **Subcategory:** currency-edge-cases
- **Scenario Number:** 10
- **Created:** 2025-10-11T21:28:31.364Z
- **Complexity:** SIMPLE
- **Risk Level:** HIGH
...
### Performance Results
- **Throughput:** 677 operations per second
- **Latency:** 132ms average response time
...
- **Throughput:** > 744 requests per second
- **Concurrent Users:** Support for 1975 concurrent users
...
- **MTBF (Mean Time Between Failures):** 859 hours
